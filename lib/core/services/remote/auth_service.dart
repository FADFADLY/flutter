...
import '../../../features/auth/data/models/logout/LogoutResponseModel.dart';
...
class AuthService {
  ...
  Future<LogoutResponseModel> logout() async {
    try {
      final token = await SecureCacheHelper.getString(key: "access_token");
      if (token == null) {
      ...
      print('Stack trace: $stackTrace');
      throw GenericException(message: 'Error during logout: $e');
    }
  }}
